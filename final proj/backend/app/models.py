...
class MitigationRequest(BaseModel):
    package_id: str
    strategy: Literal["do_nothing", "patch_isolate", "immediate_replace", "gradual_migration"] = "do_nothing"
    # Optional Transition Risk Budget constraints (P5)
    max_disruption: Optional[Literal["None", "Low", "Medium", "High"]] = None
    protect_critical: bool = False